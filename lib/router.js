...
Router.route('/share', {
  ...
  after: function() {
    document.title = 'Share with the community - recoverize';
  }
});
...
Router.route('/users', {
  ...
  after: function() {
    document.title = 'Member list / search - Recoverize';
  }
});
...
Router.route('/users/:username', {
  ...
  after: function() {
    document.title = this.params.username + '\'s profile - Recoverize';
  }
});
 ...
 * Serenity points
 */
Router.route('/serenity-points', {
  action: function() {
    this.render('serenityPoints');
  }
});
